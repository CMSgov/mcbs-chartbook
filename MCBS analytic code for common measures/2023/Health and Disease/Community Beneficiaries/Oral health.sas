...
data work.oral5;
 ...
 /*Good, very good, or excellent oral health*/
if TEETHGUM in (1:3) then ORALHLTH = 1;	/*Good, very good, or excellent*/	
else if TEETHGUM in (4:5) then ORALHLTH = 2; /*Fair or poor*/	

/*Dry mouth*/
if DRYMOUTH in (2:5) then DRYMOUTHSM = 1;	/*Sometimes, often, or always*/	
else if DRYMOUTH = 1 then DRYMOUTHSM = 2;	/*Never or rarely*/	

/*Had tooth sensitivity in the past year*/
if TOOTHSEN in (2:5) then TOOTHSENSV = 1;	/*Sometimes, often, or always*/	
else if TOOTHSEN = 1 then TOOTHSENSV = 2;	/*Never or rarely*/	
