/******************************************************************************************************/
/*** CODE: Cost Supplement File Expenditures					                                    ***/
/*** OBJECTIVE: Create expenditure measures using LDS CS file data.                                 ***/                                                                       ***/
/******************************************************************************************************/

* Create a copy of SS - Service Summary file - which is used to get the event and spending data;

DATA tempcs.ss_in ;                                                                                         
   SET cs&mcbsyear..ss( KEEP = baseid evnttype aamt: aevents ) ;                                       
RUN;  
...
DATA tempcs.hisumry_in;                                                                                         
	SET sf&mcbsyear..hisumry(KEEP = baseid H_PTAPRM H_PTBPRM H_CPRM01-H_CPRM12 H_DPRM01-H_DPRM12);
RUN;  
